...
class Chapter(db.Model):
    ...
    questions = db.relationship('QuizQuestions', backref='chapter', lazy=True, cascade='all, delete-orphan')
...
class Quiz(db.Model):
    ...
    questions = db.relationship('QuizQuestions', backref='quiz', lazy=True,cascade='all, delete-orphan')
